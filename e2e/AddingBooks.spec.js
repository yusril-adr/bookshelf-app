...
Scenario('should be able create a new completed book', async ({ I }) => {
...
Scenario('should be able create a new uncompleted book', async ({ I }) => {
  I.click('#new-book-form-toggler');
  ...
  I.seeInCurrentUrl('/uncompleted-list');
